...
num = 600;%800; %number of particles
...
transstd=1; % translation standard deviation in cm
orientstd=0.8; %orientation standard deviation in degrees
...
map_x_size = map_x_max - map_x_min + 1;
map_y_size = map_y_max - map_y_min + 1;
...
for m = 4:(map_x_size-3)
 	for n = 4:(map_y_size-3)
    	if grid_map(n,m)==1
